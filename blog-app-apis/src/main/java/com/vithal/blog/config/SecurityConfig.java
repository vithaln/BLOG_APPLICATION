package com.vithal.blog.config;
...
import com.vithal.blog.security.CustomUserDetailService;
import com.vithal.blog.security.JwtAuthenticationEntryPoint;
import com.vithal.blog.security.JwtAuthenticationFilter;
...
//this bean used in controller layer.
	...
	/*
	 * for FrontEnd connection we need use @Crossrigin if we want to use @Crossrigin
	 * we should use each controller layers... so we have alternate way for this
	 * implementations as below implemented .... looks it's global .
	 */
	@Bean
